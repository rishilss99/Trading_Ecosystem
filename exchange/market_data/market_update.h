...
#pragma pack(pop) // Undo the packed binary structure directive moving forward.
  ...
  typedef Common::LFQueue<CustomExchange::MEMarketUpdate> MEMarketUpdateLFQueue;
  typedef Common::LFQueue<CustomExchange::MDPMarketUpdate> MDPMarketUpdateLFQueue;
}

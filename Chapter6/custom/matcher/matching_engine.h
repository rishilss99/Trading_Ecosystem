...
namespace Exchange
{
    ...
    public:
        ...
        auto sendClientResponse(const MEClientResponse *client_response) noexcept
        {
            ...
            *next_write = std::move(*client_response); // This move does not actually move, it is silently transformed to a copy operation since parameter is const
        ...
        auto sendMarketUpdate(const MEMarketUpdate *market_update) noexcept
        {
            ...
            *next_write = *market_update; // Why is this copied and not moved like client response? Even if you move it'll be copied since parameter is const

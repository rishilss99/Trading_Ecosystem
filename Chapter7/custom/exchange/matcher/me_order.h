...
namespace CustomExchange
{
    struct MEOrder
    {
        ...
        MEOrder(TickerId ticker_id, ClientId client_id, OrderId client_order_id,
                ...
                Priority priority, MEOrder *prev_order, MEOrder *next_order) noexcept : ticker_id_(ticker_id), client_id_(client_id), client_order_id_(client_order_id),
    ...
    struct MEOrdersAtPrice
    {
        ...
        MEOrdersAtPrice(Side side, Price price, MEOrder *first_me_order,
                        MEOrdersAtPrice *prev_entry, MEOrdersAtPrice *next_entry) : side_(side), price_(price),

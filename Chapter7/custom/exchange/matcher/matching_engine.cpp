...
namespace CustomExchange
{
    MatchingEngine::MatchingEngine(ClientRequestLFQueue *client_requests,
                                   ...
                                   MEMarketUpdateLFQueue *market_updates) : incoming_requests_(client_requests), outgoing_ogw_responses_(client_responses),
                                                                            outgoing_md_updates_(market_updates), logger_("custom_matching_engine.log")
    {

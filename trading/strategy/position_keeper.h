...
namespace CustomTrading {
  ...
  struct PositionInfo {
    ...
    auto addFill(const CustomExchange::MEClientResponse *client_response, Logger *logger) noexcept {
  ...
  public:
    auto addFill(const CustomExchange::MEClientResponse *client_response) noexcept {

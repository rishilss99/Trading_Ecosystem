...
namespace CustomTrading {
  ...
  public:
    MarketDataConsumer(Common::ClientId client_id, CustomExchange::MEMarketUpdateLFQueue *market_updates, const std::string &iface,
  ...
  private:
    ...
    typedef std::map<size_t, CustomExchange::MEMarketUpdate> QueuedMarketUpdates;
  ...
  private:
    ...
    auto queueMessage(bool is_snapshot, const CustomExchange::MDPMarketUpdate *request);
